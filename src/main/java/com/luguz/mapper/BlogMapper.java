...
import com.luguz.entity.other.TimeLineBlog;
...
public interface BlogMapper extends BaseMapper<Blog> {
    ...
    @Results(id = "blogInfo", value = {
            ...
            @Result(property = "tags", column = "bl_id", many = @Many(select = "com.luguz.mapper.BlogMapper.findTagsByBlog",
                    fetchType = FetchType.DEFAULT)),
            @Result(property = "type", column = "ty_id", one = @One(select = "com.luguz.mapper.BlogMapper.findTypeByBlog",
                    fetchType = FetchType.DEFAULT)),
    })
    @Select("<script>" +
    ...
    @Results(value = {
            @Result(id = true, property = "blId", column = "bl_id"),
            @Result(property = "tagIds", column = "bl_id", one = @One(select = "com.luguz.mapper.BlogMapper.findTagIdsById",
                    fetchType = FetchType.DEFAULT))
    })
    @Select("select * from t_blog where bl_id=#{blId} ")
